...
def fix_sponsee():
    ...
    new_func = '''function appendInlineGeneratedCardSponsee(threadId) {
        ...
        html += '<div style="padding:12px;border-bottom:1px solid var(--bdr);">' +
            ...
            '<div style="margin-bottom:4px;"><strong>Deliverables</strong> 2 IG reels \\00B7 3 stories \\00B7 1 YouTube short</div>' +
            '<div style="margin-bottom:4px;"><strong>Deadline</strong> March 22, 2025</div>' +
            '<div style="margin-bottom:4px;"><strong>Revision rounds</strong> 1 included \\00B7 7-day review</div>' +
            "<div><strong>Usage rights</strong> 3 months \\00B7 Bangladesh</div>" +
            "</div>' +
            ...
            '<div style="margin-bottom:4px;"><strong>Deliverables</strong> 2 IG reels \\00B7 3 stories \\00B7 1 YouTube short</div>' +
            '<div style="margin-bottom:4px;"><strong>Deadline</strong> March 22, 2025</div>' +
            '<div style="margin-bottom:4px;"><strong>Revision rounds</strong> 1 included \\00B7 7-day review window</div>' +
            "<div><strong>Usage rights</strong> 3 months \\00B7 Bangladesh only</div>" +
            "</div>' +
            '<div style="font-size:10px;color:var(--grn-3);margin-top:8px;font-weight:600;">\\2713 Accepted by sponsor</div>' +
            "</div>' +
            "</div>' +
            "</div>';
        ...
        if (deal.contentSubmitted) {
            html += '<div style="padding:12px;border-bottom:1px solid var(--bdr);">' +
            '<div class="cc-hd"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="#3B6D11" stroke-width="1.3"><rect x="1.5" y="1.5" width="9" height="9" rx="1"></rect><path d="M3.5 4h5M3.5 6.5h5M3.5 9h3"></path></svg>Content submitted \\00B7 3 of 3 deliverables</div>' +
            '<div class="cc-item"><svg viewBox="0 0 11 11" fill="none" width="11"><circle cx="5.5" cy="5.5" r="4.5" fill="#C0DD97"></circle><path d="M3 5.5l2 2L8.5 3" stroke="#27500A" stroke-width="1.3" stroke-linecap="round"></path></svg>Instagram reel \\00B7 48 sec</div>' +
            ...
            '<a class="cc-link" href="#" onclick="return false;"><svg width="11" height="11" viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M5 2H2v8h8V7M7 2h3v3M5 7l5-5"></path></svg>View content files \\00B7 Google Drive</a>' +
        ...
        if (deal.dealCriteriaApproved) {
            ...
            '<div style="font-weight:600;color:var(--grn-3);margin-bottom:2px;">\\2713 Approved \\00B7 Feb 22</div>' +
...
def fix_sponsor():
    ...
    new_func = '''function appendInlineGeneratedCardSponsor(threadId) {
        ...
        if (deal.dealCriteriaApproved) {
            ...
            '<div style="display:flex;gap:8px;margin-bottom:8px;">' +
            '<div style="flex:1;font-size:10px;padding:8px;background:var(--grn-l);border-radius:var(--r1);border-left:2px solid var(--grn);">' +
            '<div style="font-weight:600;color:var(--grn-3);margin-bottom:2px;">\\2713 You approved \\00B7 Feb 22</div>' +
            '<div style="color:var(--tx2);">Content meets all criteria and deliverables</div>' +
            "</div>' +
            "</div>' +
            (deal.escrowPassedByAuthority ? '<div class="cc-actions"><button class="btn-g" onclick="submitRating()">Rate & complete deal</button></div>' : '<div style="font-size:11px;color:var(--tx3);">Waiting for platform escrow pass</div>') +
